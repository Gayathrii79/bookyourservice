...
export function EnquiryModal() {
  ...
  useEffect(() => { setSvc(service); }, [service]);
  ...
  const reset = () => {
    setName(""); setPhone(""); setSvc(""); setMessage("");
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={() => { close(); setTimeout(reset, 200); }}
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="px-6 py-7 sm:px-8">
                <h3 id="enquiry-title" className="text-xl font-semibold tracking-tight text-foreground">
                  Request a Service
                </h3>
                ...
                <div className="mt-6 space-y-4">
                  ...
                  <Field label="Phone Number" required>
                    <input
                      ...
                      required type="tel" inputMode="tel" placeholder="+91 90000 00000"
                      className="input"
                    />
                  </Field>
                  <Field label="Category">
                    <select
                      value={cat} onChange={(e) => { setCat(e.target.value); setSvc(""); }}
                      className="input"
                    >
                  ...
                  {cat && (
                    <Field label="Service">
                      ...
                      >
                        ...
                        {(categories.find((c) => c.name === cat)?.subservices ?? []).map(
                          (s) => (
                  ...
                  <Field label="Message">
                    <textarea
                      ...
                      rows={3} placeholder="Tell us what you need"
